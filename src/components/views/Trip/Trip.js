...
const Trip = ({error, name, image, cost, days, description, country, id, intro}) => {
      ...
      <Grid>
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripId={id} countryCode = {country.alpha3Code} tripName={name} tripCost={cost} tripDuration={days} />
          </Col>
        </Row>
      </Grid>
    </Section>
